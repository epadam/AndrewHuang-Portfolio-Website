...
const medical = () => {
    ...
    return (
        <div>
            ...
            {/* Row*/}
            {/* --------------------------------------------------------------------------------*/}
            <h6>My name is Andrew Huang (Cheng Chiang). During my master thesis at TUD, I succesfully applied CNN in AV1 video intra encoding and accelerate the encoding process with minor quality loss.
